...
goal: One actionable savings move; no pitch
...
- [ ] Keep the no-endorsement framing — explicitly not financial advice
- [ ] Optional: cite a specific FDIC limit/APY range at next refresh
