...
- [ ] **Rate numbers go stale fast** — refresh before each campaign refresh, and consider parameterizing the figures
- [ ] Confirm Apopka/Lake Mary/Sanford remain the right new-construction examples for the corridor
