...
- [ ] Lock the current lender shortlist (2–3 names) before this campaign goes live
- [ ] Bilingual variant — the "newer-to-the-US credit profiles" line is high-value for the PR-relocation persona; consider a Spanish version
